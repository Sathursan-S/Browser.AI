...
export const TaskStatusHeader: React.FC<TaskStatusHeaderProps> = ({
  task,
  status,
  result,
  onClose,
  ...
  // Remove auto-expand on completion to make it user-controlled
          ...
          <div className="flex-1 min-w-0">
            <div className="flex justify-between items-start gap-2">
              <div>
                ...
                <p
                  className={`text-sm font-medium text-slate-900 dark:text-slate-100 break-words leading-snug ${expanded ? '' : 'line-clamp-2'}`}
                >
                  {task}
                </p>
              </div>
