    ...
    def _register_default_actions(self):
        ...
        async def find_best_website(
            ...
            if (
                ...
                and self.location_detector.has_detected()
            ):
        ...
        async def detect_location(
            ...
            location_info = await self.location_detector.detect_location_from_browser(
                browser
            )
        ...
        async def search_ecommerce(
            ...
            if params.site:
                ...
                if (
                    self.location_detector.has_detected()
                    and self.location_detector.get_location()
                ):
                    location = self.location_detector.get_location()
